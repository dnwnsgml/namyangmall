            ...
            <div className="contents">
                <div className="contents_in">
                    <div className={styles.benefit01}>
                        ...
                        <div className={styles.benefit01_f}><p>가입선물은 유료 가입자에 한하여 지급되며 선택한 사은품은 변경 및 교환이 불가합니다</p></div>
                    </div>
                    ...
                    <div className={styles.benefit02}>
                        ...
                        <div className={styles.benefit02_b}>
                            <Item02 src='https://shoppingcdn.namyangi.com/attach/site/2023/202301/a4bd0376-6ee9-4f5b-8362-0e861b658e32.png?63cc85d' txt='첫 구매부터 15% 할인' />
                            <Item02 src='https://shoppingcdn.namyangi.com/attach/site/2023/202301/a4bd0376-6ee9-4f5b-8362-0e861b658e32.png?63cc85d' txt='구매 구간별 할인폭 증가' />
                            <Item02 src='https://shoppingcdn.namyangi.com/attach/site/2023/202301/a4bd0376-6ee9-4f5b-8362-0e861b658e32.png?63cc85d' txt='5회 구매확정 시 마다 사은품 증정(구매확정 주문건수에 한함)' />
                        </div>
                        <div className={styles.benefit02_f}><p>단계별 한 사람이 구매할 수 있는 구매 총량은 한정되어 있으며, 구매량에 관계없이 구매 횟수로 사은품제공 및 할인율이 차등 적용됩니다.</p></div>
                    </div>
