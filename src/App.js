        ...
        <div className='header'>
          <div className='header_in'>
            <div className='logo'>
              ...
              <Link to="/"><img src={require('./images/logo.png')} alt=''></img></Link>
            </div>
            <div className='nav'>
              <ul>
                <li><Link to="/components/member" style={{ textDecoration: 'none', color: '#000' }}>프리미엄멤버쉽</Link></li>
                <li><Link to="/components/product" style={{ textDecoration: 'none', color: '#000' }}>냉장제품</Link></li>
                <li><Link to="/components/market" style={{ textDecoration: 'none', color: '#000' }}>시크릿마켓</Link></li>
                <li><Link to="/components/brand" style={{ textDecoration: 'none', color: '#000' }}>브랜드관</Link></li>
                <li><Link to="/components/pop" style={{ textDecoration: 'none', color: '#000' }}>기획전</Link></li>
                <li><Link to="/components/event" style={{ textDecoration: 'none', color: '#000' }}>이벤트</Link></li>
                <li><Link to="/components/delivery" style={{ textDecoration: 'none', color: '#000' }}>가정배달</Link></li>
              </ul>
            </div>
          </div>
        </div>
